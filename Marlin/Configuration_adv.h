...
#define HOMING_BUMP_DIVISOR { 6, 6, 8 }  // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
//efine STATUS_MESSAGE_SCROLLING
 ...
 */
#define MINIMUM_STEPPER_POST_DIR_DELAY 40
#define MINIMUM_STEPPER_PRE_DIR_DELAY 40
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_UNLOAD_RETRACT_LENGTH       3  // (mm) Unload initial retract length.
